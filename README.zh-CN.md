...
我是产品经理，不是程序员。我个人的 `CLAUDE.md` 文件第一行就这么写着。

几个月来我一直用 Claude Code 验证产品想法。让我崩溃的不是 bug，而是 Claude 信誓旦旦地说"我修好了"——但其实没修。同一个对话、同一个 bug，连续三次。
...
- **Environment > Model**（环境比模型重要）—— 不追求更强的 AI，追求更好的验证环境
- **物理约束 > AI 的承诺** —— 跑真实工具去验证，不信"我修好了"这句话
- **规格优先 > 代码优先** —— 让 AI 先写清楚要做什么，再动手做
