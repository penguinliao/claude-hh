...
> Claude H-H v0.2 发布 — 一个 AI 代码质量门禁系统的自我进化故事
...
作为一个不懂代码的产品经理，我没法自己审代码。所以我做了一个系统：**Claude H-H** — 一套 Hook 物理约束，强制 AI 走"先写需求 → 再写代码 → 机器审查 → 机器测试"的流水线。不信任 AI 说"我修好了"，而是让工具真跑一遍验证。
...
今天在用 Claude H-H 开发一个新项目时，我注意到 AI（Claude Opus）做了一件很聪明的事：
...
**Claude H-H** 是一个开源的 AI 代码质量门禁系统，基于 Claude Code Hook 实现。
